...
| **Filesystem UI** | JupyterLab-style browser — `docs/FILESYSTEM_JUPYTERLAB_PLAN.md` |
| **Mobile UX** | Bottom nav shell (Files / Notebook / Session / More), touch targets, on-screen Python code keys — `docs/MOBILE_UX_PLAN.md` |
