...
Use this skill when the user wants grounded repository architecture documentation in Claude Code.
...
4. If setup is missing, ask for permission before starting `npx archify-cli init --install-mode project --project-path . --platform claude-code`.
